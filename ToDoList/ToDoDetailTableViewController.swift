...
//  ToDoList
//
//  Created by Li Tzu Lin on 2022-01-30.
//
...
class ToDoDetailTableViewController: UITableViewController {
    ...
    @IBOutlet var duDateLabel: UILabel!
    ...
    override func tableView(_ tableView: UITableView, estimatedHeightForRowAt indexPath: IndexPath) -> CGFloat {
        switch indexPath {
        case datePickerIndexPath: return 400
        case notesIndexPath: return 200
    ...
    func updateDueDateLabel(date: Date) {
        duDateLabel.text = date.formatted(.dateTime.month(.defaultDigits).day().year(.twoDigits).hour().minute())
    }
    ...
    @IBAction func datePickeerChanged(_ sender: UIDatePicker) {
